...
public class FlyController : MonoBehaviour
{
    ...
    private int focusIns = 0;
    private int focusLines = 0;
    ...
    void Update()
    {
        ...
        {
            FocusCameraOnGameObject(Camera.main, dataHandler.changedObjects[focusIns]);
            if (focusIns == dataHandler.changedObjects.Count - 1)
            {
                focusIns = 0;
            }
            else
        ...
        {         
            FocusCameraOnGameObject(GetComponent<Camera>(), dataHandler.changedLines[focusLines]);
            if (focusLines == dataHandler.changedLines.Count - 1)
            {
                focusLines = 0;
            }
            else
