namespace TurnTheGameOn.SimpleTrafficSystem
{
    ...
    public class Editor_AITrafficWaypointRoute : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            SerializedProperty randomSpawnFromPool = serializedObject.FindProperty("randomSpawnFromPool");
            EditorGUI.BeginChangeCheck();
            EditorGUILayout.PropertyField(randomSpawnFromPool, true);
            if (EditorGUI.EndChangeCheck())
                serializedObject.ApplyModifiedProperties();
        ...
        public Transform ClickToSpawnYieldTrigger(AITrafficWaypointRoute __AITrafficWaypointRoute, Vector3 _position)
        {
            ...
            if (routeInfo.yieldTrigger == null)
            {
                ...
                GameObject yieldTrigger = Instantiate(Resources.Load("YieldTrigger"), _position, Quaternion.identity, __AITrafficWaypointRoute.transform) as GameObject;
